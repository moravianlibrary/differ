...
// 1. PSNR 
// 2. Universal Image Quality Index
// 3. MSSIM 
// for the two images to be compared.
...
double calcQualityIndex(IplImage* src1, IplImage* src2, const int B = 8);
...
int main( int argc, char** argv )
{
  ...
  //Calculating the Image Quality Index
  double image_quality_index = calcQualityIndex(gray1,gray2);
  //psnr = calcPSNR(src1, src2);
  cout<<"Image Quality Index = "<<image_quality_index<<"\n";
