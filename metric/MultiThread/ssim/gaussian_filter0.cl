__kernel void gaussian_filter(__global float *input, __global float *filter, __global float *out, const int img_height, const int img_width, const int nChan, const int size_filter) {
